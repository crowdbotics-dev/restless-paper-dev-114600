...
## Project Structure
    ...
    ├── restless_paper_dev_114600  # Django project configurations
...
1. Clone this repo and `cd restless_paper_dev_114600`
...
2. Clone this repo and `cd restless_paper_dev_114600`
